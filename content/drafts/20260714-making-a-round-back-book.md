---
title: "Making a Round Back Book"
excerpt: "Apply rounding techniques to create a professional hardcover book with a shaped spine. A complete project from text block to finished binding."
category: "Project"
date: "Jul 14, 2026"
...
**Attachment:**
- Tip one endpaper to outside of first signature (thin line of paste at fold)
- Tip one endpaper to outside of last signature
- Two spare endpapers for later attachment

#### Marking and Punching Stations
...
1. Fan text block slightly
2. Apply thin coat of PVA to spine
...
If edges are uneven, trim now:
1. Use a plough or sharp blade with straight edge
2. Trim fore edge first
3. Then head, then tail
4. Remove minimum necessary
...
1. Place text block on clean, flat surface
2. Have backing hammer ready
3. Work in area where you can apply force

#### Rounding Process

1. Hold text block with fore edge toward you
2. Using hammer or hands, push center of spine away from you
...
- Thumbs on spine, fingers on fore edge
- Roll spine forward while curving fore edge back
- Work from center outward

**Checking your work:**
- View from head or tail
- Spine should show even curve
...
1. Place backing boards against text block
2. Boards should be exactly at shoulder line (where cover boards will sit)
3. Leave spine exposed
4. Clamp firmly in press or between boards in vise

**Alignment critical:** Boards must be parallel and at equal height on both sides.

#### Backing Process

1. Begin at center of spine
2. Angle backing hammer to push signatures outward
3. Work from center toward one edge
4. Light, overlapping blows
5. Repeat from center toward other edge
6. Alternate sides to maintain symmetry
7. Continue until shoulders form

**Shoulder formation:**
- Outer signatures fold over backing boards
...
1. Cut kraft paper to spine width (within shoulders)
...
5. Loose outer layer will attach to case spine
...
1. Cut headbands to spine width
2. Position at head with colored edge facing out
3. Glue in place
4. Repeat at tail
...
2. Gap between boards and spine: Slightly larger than for flat spine
...
1. Apply paste to mull overhangs and first endpaper (waste sheet)
2. Position text block in case, spine in spine hollow
3. Press firmly, especially at shoulders
...
1. Turn book over
2. Apply paste to other mull overhang and endpaper
3. Close back cover
4. Check alignment
...
**Structure:**
- [ ] Spine curve maintained
- [ ] Shoulders accommodate boards
- [ ] Book opens without strain
- [ ] Closes flat without gapping

**Appearance:**
- [ ] Squares even on all sides
- [ ] Spine covering smooth
- [ ] Corners sharp and neat
- [ ] No adhesive showing

**Function:**
- [ ] Opens to comfortable angle
- [ ] Pages turn easily
...
|-------|--------------|----------------|
| Lost the round | Pressed flat before case | Work quickly at casing-in |
| Uneven shoulders | Backing inconsistent | Practice backing technique |
| Boards don't fit shoulders | Measured incorrectly | Re-measure around curve |
