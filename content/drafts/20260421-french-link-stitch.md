...
excerpt: "Learn sewing onto tapes for extra strength. The French link stitch creates elegant exposed sewing while adding structural support."
category: "Technique"
date: "Apr 21, 2026"
...
**Combines:**
- Visible chain stitch pattern (like Coptic)
- Tape supports at sewing stations
- Strong structural connection
- Decorative exposed spine

**Results in:**
- Books that open well
...
| Link stitch | Good | Visible | Intermediate |
...
- 2 kettle stations (head and tail)
...
3. Re-enter signature on other side of tape
4. Sew inside to tape 2
5. Exit, wrap around tape 2, re-enter
6. Continue to tape 3
7. Exit, wrap around tape 3, re-enter
8. Exit at tail kettle station
9. Leave thread tail for tying
...
3. At tape 3: exit, link to signature 1 (the French link), re-enter
4. Continue through signature
5. At each tape: exit, link to previous signature, re-enter
...
1. Thread exits signature at tape station
2. Pass needle behind the tape
3. Loop around the thread from previous signature (creating link)
4. Pass behind tape again
5. Re-enter signature on other side of tape
...
2. At each tape: French link to previous signature
...
2. Thread tapes through slots
3. Fray and paste down tape ends
4. Cover with pastedown
...
|---------|-------|----------|
| Links uneven | Inconsistent technique | Practice, develop rhythm |
...
**Thread Tension:**
- Snug but not tight
- Tapes should stay centered
- Links should lie flat

**Rhythm:**
- Develop a consistent motion
